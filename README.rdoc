...
Server-side code should work in following way:
    ...
    * all calculations previously made should be stored in the database; if an operation with given parameters hasn't been made yet, it should be saved; otherwise calculation result should be fetched from DB
...
server response should equal to 4 lines of text in following format:
    ...
    * ID: C
    * Count: D, where:
        A will be equal to text interpretation of the operation (e.g. in     case of sum of numbers 24 and 23 A should be equal to “24 + 23”
